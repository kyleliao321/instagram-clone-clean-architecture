...
class GetLocalLoginUserIdUseCase(
    private val appRepository: AppRepository,
    defaultDispatcher: CoroutineDispatcher = Dispatchers.IO
) : UseCase<Int, Unit>(defaultDispatcher) {

    override suspend fun run(params: Unit): Either<Int, Failure> =
        appRepository.getLocalLoginUserId()
