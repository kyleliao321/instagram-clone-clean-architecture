...
class UserLikePostUseCaseTest {
    ...
    private lateinit var testUseCase: UserLikePostUseCase

    @Before
    fun setup() {
        MockKAnnotations.init(this)

        testUseCase = UserLikePostUseCase(profileRepository, mainCoroutineRule.testDispatcher)
    }
